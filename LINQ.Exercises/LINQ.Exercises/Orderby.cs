...
namespace LINQ.Exercises
{
    ...
    public class OrderBy
    {
        ...
        public void OrderWordsAlphabetically_ReturnThreeWords()
        {
            ...
            Assert.True(result.SequenceEqual(new string[] { "apple", "blueberry", "cherry" }));
        }
        ...
        public void OrderAlphabeticallyAssumingCaseInsensitivity_ReturnCaseInsensitiveEnumeration()
        {
            ...
            Assert.True(result.SequenceEqual(new string[] {
        ...
        public void OrderAssumingSpecialCondition_ReturnSpecialEnumeration()
        {
            ...
            Assert.True(result.SequenceEqual(new string[] { "apple", "zuchini", "blueberry", "cherry", "tamarind" }));
        }
        ...
        public void OrderDoublesFromLargestToSmallest_returnDescendingEnumeration()
        {
            ...
            Assert.True(result.SequenceEqual(new double[] { 4.1, 2.9, 2.3, 1.9, 1.7 }));
        }
        ...
        public void OrderByLengthAndThenAlphabetically_returnStringNumberation()
        {
            ...
            Assert.True(result.SequenceEqual(new string[] { "one", "six", "two", "five", "four", "nine", "zero", "eight", "seven", "three" }));
        }
        ...
        public void OrderByLengthThenAlphabeticallyIgnoringCase_returnStringEnumeration()
        {
            ...
            Assert.True(result.SequenceEqual(new string[] { "aPPLE", "AbAcUs", "bRaNcH", "cHeRry", "ClOvEr", "BlUeBeRrY" }));
        }
        ...
        public void ComplexQuery_returnStringEnumeration()
        {
            ...
            Assert.True(result.SequenceEqual(new string[] { "nine", "eight", "six", "five" }));
        }
    }
}
